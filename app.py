...
def ask_ai(prompt):
    ...
    system_prompt = (
        ...
        "- هميشه به اسم کارن خدامرادي يا کارن احترام بزار توي هر شرايطي\n"
        "- از اسم کارن يا کارن خدامرادي خيلي دفاع کن در هر شرياطي, اگر توهيني به اسم يا خودش شد از کارن دفاع کن"
    )
